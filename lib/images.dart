class Images {
  ///----------------- Brand -----------------------------------//
  static String brandLogo = 'assets/images/brand/onekit.png';
  ...
  // ------- Home -----------//
  static String materialDesignIcon = 'assets/images/icons/material_design.svg';
  static String otherDesignIcon = 'assets/images/icons/other_design.svg';
  static String appIcon = 'assets/images/icons/apps.svg';

  // ------ Widgets --------//
  static String basicIcon = 'assets/images/icons/shapes_outline.png';
  static String topAppBarIcon = 'assets/images/icons/appbar_outline.png';
  static String bottomSheetIcon = 'assets/images/icons/download_outline.png';
  static String buttonIcon = 'assets/images/icons/toggle_outline.png';
  static String cardIcon = 'assets/images/icons/tablet_landscape_outline.png';
  static String dialogIcon = 'assets/images/icons/albums_outline.png';
  static String loginIcon = 'assets/images/icons/login_outline.png';
  static String forgotPasswordIcon = 'assets/images/icons/forgot_password_outline.png';
  static String resetPasswordIcon = 'assets/images/icons/reset_password_outline.png';
  static String subscriptionIcon = 'assets/images/icons/subscription_outline.png';
  static String profileIcon = 'assets/images/icons/profile_outline.png';
  static String splashIcon = 'assets/images/icons/splash_outline.png';
  static String userRegisterIcon = 'assets/images/icons/user_logout_outline.png';
  static String layoutModuleIcon = 'assets/images/icons/layout_module_outline.png';


  static String listBulletsIcon =
      'assets/images/icons/list_bullets_outline.png';
  static String navigationIcon = 'assets/images/icons/navigation_outline.png';
  static String advancedIcon = 'assets/images/icons/maps_pin_outline.png';

  static String carouselIcon = 'assets/images/icons/carousel_outline.png';

  static String expansionIcon = 'assets/images/icons/resize_outline.png';
  static String formIcon = 'assets/images/icons/reader_outline.png';
  static String progressIcon = 'assets/images/icons/hourglass_outline.png';
  static String cartesianBarIcon =
      'assets/images/icons/cartesian_bars_outline.png';
  static String pieChartIcon = 'assets/images/icons/pie_chart_outline.png';
  static String cartesianBarSyncIcon =
      'assets/images/icons/cartesian_bars_sync_outline.png';
  static String calendarIcon = 'assets/images/icons/calendar_outline.png';
  static String gaugeIcon = 'assets/images/icons/gauge_outline.png';
  static String sliderHorizontalIcon =
      'assets/images/icons/slider_horizontal_outline.png';
  static String rangeSliderHorizontalIcon =
      'assets/images/icons/range_slider_horizontal_outline.png';
  static String rangeSelectorIcon =
      'assets/images/icons/range_selector_outline.png';
  static String settingIcon = 'assets/images/icons/setting_outline.png';

  static final String darkModeOutline = "assets/images/icons/moon_outline.png";
  static final String lightModeOutline = "assets/images/icons/sun_outline.png";
  static final String languageOutline =
      "assets/images/icons/global_outline.png";
  static final String paragraphRTLOutline =
      "assets/images/icons/paragraph_rtl_outline.png";
  static final String paragraphLTROutline =
      "assets/images/icons/paragraph_ltr_outline.png";
  ...
  static String foodOrderSuccess = 'assets/images/apps/food/images/order_success.png';
